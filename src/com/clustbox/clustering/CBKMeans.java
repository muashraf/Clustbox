...
public class CBKMeans implements Clusterer {
	...
	private Instance[]  initCentroids; // centroids: the center of clusters for the first iteration
	...
	public CBKMeans(int clusters, int iterations, DistanceMeasure dm, Instance[] initcentroids) {
		this.numberOfClusters = clusters;
		this.numberOfIterations = iterations;
		this.dm = dm;
	...
	public Dataset[] cluster(Dataset data) {
		...
		if (initCentroids != null){
			this.centroids = initCentroids.clone();
		}
		else {
